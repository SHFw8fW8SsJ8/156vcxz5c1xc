...
// JavaScript function to handle form submission and clear the form with a delay
function submitForm(event) {
    event.preventDefault(); // Prevent the default form submission

    // Handle form data here if needed (e.g., send to server)

    // Delay clearing the form by 2 seconds (2000 milliseconds)
    setTimeout(function() {
        document.getElementById("myForm").reset();
    }, 1000); // Adjust the delay time in milliseconds (2000ms = 2 seconds)
}
